...
int main() {
    const char* input1 = "30001";
    const char* output1 = f(input1);
    printf("f(%s) = %s\n", input1, output1 ? output1 : "Output not found");

    const char* input2 = "55555";
    const char* output2 = f(input2);
    printf("f(%s) = %s\n", input2, output2 ? output2 : "Output not found");

    const char* input3 = "77788";
    const char* output3 = f(input3);
    printf("f(%s) = %s\n", input3, output3 ? output3 : "Output not found");
